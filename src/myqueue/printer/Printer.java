...
public class Printer {
    private final SimplePriorityQueue<TaskWithTime> printerTasks;
    private final SimplePriorityQueue<TaskWithTime> tasksWithTime;

    public Printer() {
        this.printerTasks = new SimplePriorityQueue<>((o1, o2) -> {
        ...
        this.tasksWithTime = new SimplePriorityQueue<>((o1, o2) -> {
